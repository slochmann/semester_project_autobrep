...
% ===============================================================
% Load multirow for multi-row table cells
% ===============================================================
\usepackage{multirow}
% Enables merging of multiple rows in tables with the \multirow command.

% ===============================================================
% Load pdfpages for including PDF pages
% ===============================================================
\usepackage{pdfpages}
% Enables inclusion of external PDF pages with the \includepdf command.
...
\begin{document}
    ...
    \section*{Declaration of Origin}
    \includepdf[pages=-]{figures/declaration_of_origin.pdf}
    % Includes the declaration_of_origin.pdf file at the end of the document.
